...
const contaCorrente4 = new ContaCorrente('1234', cliente5ContaCorrente1, 100); // O último argumento é o limite
...
const contaCorrente5 = new ContaCorrente('5678', cliente5ContaCorrente2, 100); // O último argumento é o limite
...
if (contaCorrente4.calcularSaldo() >= valorTransferencia) {
  contaCorrente4.sacar(valorTransferencia);
  contaCorrente5.depositar(valorTransferencia);
